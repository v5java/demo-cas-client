...
public class JettyBootStrap {
	...
	private void log(long time) {
		...
		//记得配置hosts127.0.0.1到boss.jadyer.com
		System.err.println("[INFO] Server running in " + time + "ms at http://boss.jadyer.com" + (80==this.port?"":":"+this.port) + this.context_path);
